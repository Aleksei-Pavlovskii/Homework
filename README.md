...
## Модуль read csv xlsx files
Модуль содержит функции которые конвертируют валюту и возвращают сумму транзакций

### Установка и использование
Скопируйте модуль `read_csv_xlsx_files.py` в свой проект

## Модуль filter_data
Модуль содержит функцию, которая приводит список словарей к единому виду

### Установка и использование
Скопируйте модуль `filter_data.py` в свой проект 